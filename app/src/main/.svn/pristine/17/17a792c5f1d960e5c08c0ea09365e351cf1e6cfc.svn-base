...
public class ClearableAutoCompleteTextView extends androidx.appcompat.widget.AppCompatAutoCompleteTextView
    ...
    public Drawable imgClearButton = getResources().getDrawable(R.drawable.ic_clear_red);
    public Drawable imgClearButtonWhite = getResources().getDrawable(R.drawable.ic_clear_white);
    ...
    public void afterTextChanged(Editable s) {
        if (s.length() > 0) {
            ...
            Drawable clearButton = null;
            if(isReadOnly()){
                clearButton = imgClearButtonWhite;
            }else{
                clearButton = imgClearButton;
            }
