...
public class TabDlistActivity extends AppCompatActivity {
    ...
    private static final String DEBUG_TAG = TabDlistActivity.class.getSimpleName();
    ...
    private void displayDlistFieldNames() {
        ...
        try {
            int dlistArrPosition = FormFragment.dlistArrayPosition;
            List<Field> dlistArray = FormFragment.fieldsList.get(dlistArrPosition).getdListArray();
...
//        }
    ...
    public static class DlistPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return  DlistFragment.newInstance(dlistButtonPositions.get(position),mFieldIds.get(position));
        }
