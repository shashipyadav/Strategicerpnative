...
public class VlistDlistFormActivity extends AppCompatActivity implements
        View.OnClickListener, DlistFieldInterface, CustomDateTimePickerInterface {

    private static final String DEBUG_TAG = VlistDlistFormActivity.class.getName();
    ...
    private BottomSheetDropdown.BottomSheetClickListener bottomSheetClickListener =
            new BottomSheetDropdown.BottomSheetClickListener() {
                ...
                public void getSelectValues(String valueString, final int fieldPosition) {
                    ...
                    onValueChanged(fieldPosition,fieldValue,false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            fieldPosition = VlistFormActivity.vDlistArrayPosition;
    ...
    private void initDatabase() {
        dbManager = new DatabaseManager(VlistDlistFormActivity.this);
        dbManager.open();
    }
    ...
    private void initForm() {
        ...
        mFunctionHelper = new DlistFunctionHelper(VlistDlistFormActivity.this);
...
//        });
    ...
    private void callAPI(String url, final int position, final boolean isPayLoad) {
        ...
        if(isValidURL) {
            ...
            if (NetworkUtil.isNetworkOnline(VlistDlistFormActivity.this)) {
                showProgressDialog();

                RequestQueue queue = Volley.newRequestQueue(VlistDlistFormActivity.this);
                ...
                ToastUtil.showToastMessage("Please check your internet connection and try again", VlistDlistFormActivity.this);
    ...
    private void showProgressDialog() {
        if (fetchCounter == 0) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    progressDialog1 = ProgressDialog.show(VlistDlistFormActivity.this, "", "Fetching Details ...", false);
                }
            });
        }
        fetchCounter++;
    ...
    private void displayDatePicker(final int position) {
        ...
        }, null, null, VlistDlistFormActivity.this);
...
//        });
        ...
        if (!function.isEmpty()) {
            ...
            for (int i = 0; i < jarr.length; i++) {
                ...
                if(jarr[i].contains("clearfieldids")) {
                    ...
                    String evSqlURL = mFunctionHelper.evaluatesql(fieldId, extension, jcodeList, value, dlistFieldValues,true);
                    ...
                    String fndlistURL = mFunctionHelper.fn_dlist(formid, fieldid, matchingField, matchingFieldIds, finalDlistid,dlistformid,true);
                    ...
                    Thread t = new Thread(new Runnable() {
                        @Override
                        public void run() {
                            mFunctionHelper.totaldlist(id,fieldid,dlistid,doround,true);
                        }
                    });
                    t.start();
    ...
    public void checkPattern(String funcString, final String value, final int position) {
        ...
        int resultPosition = cp.checkPattern(fieldId, regexPattern, extension, dlistFieldValues.get(position).getFieldName(), true);
        if (resultPosition != -1) {
    ...
    public void onValueChanged(int position, String value,boolean doUpdateRecyclerView) {
        ...
        updateDListInDb();
        Log.e("ONVALUECHANGE", "SETVALUE = " + value);
        ...
        if (!dropDownClickFunc.isEmpty()) {
            ...
            if (dropDownClickFunc.contains("load")) {
                        ...
                        fieldType.toLowerCase().equals("dcombo"))
                {
                    ...
                    BottomSheetDropdown bottomSheetFragment = new BottomSheetDropdown(bottomSheetClickListener,true);
  ...
  /*  @Override
    ...
    private void createNewDList(){
        if(mDlistButtonPosition != -1) {
            ...
            dlistFields = VlistFormActivity.vFieldsList.get(fieldPosition).getdListArray().get(mDlistButtonPosition).getdListsFields();
...
//                        }
            ...
            SharedPrefManager prefManager = new SharedPrefManager(VlistDlistFormActivity.this);
            ...
            dlistRowsCount = getTotalNoOfRows();
            DListFieldHelper fieldHelper = new DListFieldHelper(VlistDlistFormActivity.this);
    ...
    {
       // int dlistArrayField = VlistFormActivity.vDlistArrayPosition;
        String url= "";
        String dlistspanids = "";
        ...
        List<Field> fieldsList  = VlistFormActivity.vFieldsList;

        List<Field> additionalDataList = VlistFormActivity.vAdditionalFieldDataList;
    ...
    private void putfunctionvalues(String func, String extension,
        ...
        int position = -1;
        List<Field> fieldsList = VlistFormActivity.vFieldsList;
        List<Field> additionalFieldList = VlistFormActivity.vAdditionalFieldDataList;
                                ...
                                if (!editpartid.equals("")) {
                                    ...
                                    for (int n = 0; n < fieldsList.size(); n++) {
                                        ...
                                        if (nObj.getId().equals("field" + editpartid)) {
                                            ToastUtil.showToastMessage("Please select the required options.", VlistDlistFormActivity.this);
